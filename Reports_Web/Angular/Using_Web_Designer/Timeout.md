...
When working with the **StiNetCoreDesigner** component, you can set the timeout for various operations — [storing the report in the cache](../../ASP_NET_Core/Using_Web_Designer/Timeout.md#cachetimeout), [server response](../../ASP_NET_Core/Using_Web_Designer/Timeout.md#requesttimeout), and [query execution](../../ASP_NET_Core/Using_Web_Designer/Timeout.md#commandtimeout). The timeout setting is done using the component properties and report options.
